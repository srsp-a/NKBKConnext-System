...
ใช้ **Firestore เดียวกับระบบ** แยก deploy ได้ ไม่ต้องรัน line-webhook

## Production (Firebase — ใช้อยู่)

| รายการ | ค่า |
|--------|-----|
| URL | https://monitor-api.nkbkcoop.com |
| โปรเจกต์ | `admin-panel-nkbkcoop-cbf10` |
| Deploy | `firebase deploy --only functions:monitorApi,hosting:monitor` |
| คู่มือ | `../docs/FIREBASE_SETUP.md`, `../docs/MONITOR_FIREBASE_ROLLOUT.md` |

> **Legacy:** deploy บน Plesk `nkbk.srsp.app` — ปิดหลังย้ายครบ (ดูด้านล่าง)
